 ...
 * @generated
 */
package demo.thrift.tutorial;

import demo.thrift.shared.SharedService;

@SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused"})
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2017-02-03")
public class Calculator {
    ...
    public interface Iface extends SharedService.Iface {
        ...
        public int calculate(int logid, Work w) throws InvalidOperationException, org.apache.thrift.TException;
    ...
    public static class Client extends SharedService.Client implements Iface {
        ...
        public int recv_calculate() throws InvalidOperationException, org.apache.thrift.TException {
    ...
    public static class AsyncClient extends SharedService.AsyncClient implements AsyncIface {
        ...
        public static class calculate_call extends org.apache.thrift.async.TAsyncMethodCall<Integer> {
            ...
            public Integer getResult() throws InvalidOperationException, org.apache.thrift.TException {
                if (getState() != State.RESPONSE_READ) {
                    throw new IllegalStateException("Method call not finished!");
                }
                org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
                ...
                return new org.apache.thrift.async.AsyncMethodCallback<Integer>() {
                    ...
                    public void onError(Exception e) {
                        ...
                        if (e instanceof InvalidOperationException) {
                            result.ouch = (InvalidOperationException) e;
    ...
    public static class calculate_result implements org.apache.thrift.TBase<calculate_result, calculate_result._Fields>, java.io.Serializable, Cloneable, Comparable<calculate_result> {
        ...
        public int success; // required
        public InvalidOperationException ouch; // required
        ...
        public calculate_result(calculate_result other) {
            ...
            this.success = other.success;
            if (other.isSetOuch()) {
                this.ouch = new InvalidOperationException(other.ouch);
            }
        }
        ...
        public InvalidOperationException getOuch() {
            return this.ouch;
        }

        public calculate_result setOuch(InvalidOperationException ouch) {
            this.ouch = ouch;
            return this;
        }
            ...
            switch (field) {
                ...
                case OUCH:
                    if (value == null) {
                        ...
                        setOuch((InvalidOperationException) value);
                    }
                    break;
            ...
            public void read(org.apache.thrift.protocol.TProtocol iprot, calculate_result struct) throws org.apache.thrift.TException {
                ...
                while (true) {
                    ...
                    switch (schemeField.id) {
                        ...
                        case 1: // OUCH
                            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                                struct.ouch = new InvalidOperationException();
